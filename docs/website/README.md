...
### Strongest public-facing source material

The following documents already have an accessible public form. They remain
Drafts or, in the case of the vision, a Scaffold:

- [AI Rights 101](../education/ai-rights-101.md), the
...
These sources may support concise website summaries when their Draft or
Scaffold status and actual review limits remain visible.

### Material that needs a guided public layer
...
The [Scientific Position](../principles/scientific-position.md), [AI Dignity
Charter](../principles/ai-dignity-charter.md), and [Precaution
Framework](../principles/precaution-framework.md) are Scaffolds. They may show
what work remains, but their candidate language must not be republished as if
it were a completed Draft or adopted project position. The reserved
[published-research area](../research/README.md) is not evidence that a
reviewed public research output already exists.

### Repetition to manage deliberately
...
- separation of moral consideration, legal personhood, and political power.

The website should state each briefly where readers need it, then link to one
canonical explanation. Repetition should work as a safety guardrail, not as a
set of subtly different claims.

### Transitions the website must add
...
- **Principles to policy:** values become specific, reviewable institutional
  options rather than automatic legal rights;
